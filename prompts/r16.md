# World Cup 2026 round of 16: prediction request
...
As with the round of 32, you have real results as context below and
should use them. Predict the outcome of the 8 round of 16 fixtures that
follow. Knockout matches cannot end in a draw: if a match is level after
90 minutes it goes to extra time, and if still level, penalties. Predict
the winner and, separately, your best guess at the 90-minute scoreline
(which may itself be a draw, since that's still possible before extra
time).

Base your prediction on the round of 32 results and final group standings
below, plus anything else you find relevant: historical knockout-round
pedigree, squad depth and fatigue four matches into the tournament, and
head-to-head history if any exists between these two opponents.
...
Rules:
- Exactly one prediction per fixture, 8 in total
...
[
  {"id": "R16-1", "home": "PAR", "away": "FRA"},
  {"id": "R16-2", "home": "CAN", "away": "MAR"},
  {"id": "R16-3", "home": "BRA", "away": "NOR"},
  {"id": "R16-4", "home": "MEX", "away": "ENG"},
  {"id": "R16-5", "home": "POR", "away": "ESP"},
  {"id": "R16-6", "home": "USA", "away": "BEL"},
  {"id": "R16-7", "home": "ARG", "away": "EGY"},
  {"id": "R16-8", "home": "SUI", "away": "COL"}
]
