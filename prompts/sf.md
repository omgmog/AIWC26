# World Cup 2026 semi-finals: prediction request
...
and should use them. Predict the outcome of the 2 semi-final fixtures
...
relevant: historical knockout-round pedigree, squad depth and fatigue six
matches into the tournament, and head-to-head history between these
opponents.
...
Rules:
- Exactly one prediction per fixture, 2 in total
...
[
  {"id": "SF-1", "home": "FRA", "away": "ESP"},
  {"id": "SF-2", "home": "ENG", "away": "ARG"}
]
